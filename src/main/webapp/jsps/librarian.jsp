...
function detailsbook() {
	document.forms[0].action="${pageContext.request.contextPath}/viewbooks";
...
<input type="button" onclick="detailsbook()" value="allbooks">
</form>
<div class="container">
<header><h3>All The Details are Mentioned In Librarian</h3></header>
<nav><ul>
<li><a href="${pageContext.request.contextPath}/jsps/student.jsp">StudentRegistration</a></li></br>
